...
class App extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      React.createElement("input", { type: "checkbox", onChange: this.powerControl }),
      ...
      React.createElement("input", { className: "slider", type: "range", min: "0", max: "1", step: "0.01", value: this.state.sliderVal, onChange: this.adjustVolume })))));
